            ...
            children: [
                  ...
                  Align (
                    ...
                    child: device.isConnected
                      ? Icon(Icons.bluetooth_connected,color: Colors.greenAccent,size: 20)
                      : Icon(Icons.bluetooth_disabled, color: Colors.red, size: 20),
                  ),
                  ...
                  Opacity(
                    opacity: 0.5,
                    child: Icon (Icons.wb_incandescent, color: Colors.blueGrey, size: 40, ),),
